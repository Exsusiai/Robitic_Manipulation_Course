...
int main(int argc, char **argv) {
  ...
  //TODO:read transformations from tf (Hints: use lookupTransform function as you 	did in exercsie 1)
  ...
  // (Hints: we show two example here. (Use this as reference)
   // - e1 represent for translation in X axis while
   // - e2 represents for translation in X axis and rotation around X axis)
  ...
  //TODO: planning from START to PREGRASP
  // Hints: the example below show how you do the planning from A to B, for example in this case, you do the planning from START to e1. (Use this as reference)
  ...
  //TODO: Compute cartesian path from PREGRASP to GRASP
  // Hints: the example below shows how you compute cartesian path from the current "state" to "pose" (which is converted from e2). (Use this as reference)
g_arm.setStartState(state);
  ...
  //TODO: Compute cartesian path from GRASP to PREGRASP
  g_arm.setStartState(state);
  ...
  //TODO: planning from PREGRASP to PLACE (do the same as shown in Hints: line 73)
  g_arm.setStartState(state);
